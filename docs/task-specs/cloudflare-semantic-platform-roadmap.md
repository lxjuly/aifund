...
Local note: until SQLPrism is published, `apps/web` should use a deployable in-repo adapter. Cloudflare production builds cannot resolve the sibling workspace dependency `file:../../../sqlprism`.
